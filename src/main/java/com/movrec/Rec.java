...
public class Rec {
	...
	public static void main(String[] args) {
		...
		// SETUP
		// Simon  String basepath = "/home/simon/bigDataPraktikum/";
		// Matze
	    ...
	    String path = basepath+"ml-latest/ratings1.csv";
	    JavaRDD<Rating> ratings = parseRatings(path, sc);
	    
	    System.out.println("Data-Set:" +ratings.count());
	   
	    // Add user ratings to the data set
	    JavaRDD<Rating> userRating = parseRatings(basepath+"ml-latest-small/userrating.csv", sc);
